...
#Begin I/O redirection
{
    ...
    /home/george/vtr-verilog-to-routing/vtr_flow/scripts/run_vtr_flow.pl /home/george/vtr-verilog-to-routing/vtr_flow/benchmarks/mix_soft_and_hard_logic//kexp_normal.v /home/george/vtr-verilog-to-routing/vtr_flow/arch/mix_soft_and_hard_logic/k6_frac_N10_mem32K_40nm_fixed.xml  -name 'mixing_optimization/kexp_normal: k6_frac_N10_mem32K_40nm_fixed.xml/kexp_normal.v/common'   -temp_dir .  -custom_odin_config_full_name /home/george/vtr-verilog-to-routing/vtr_flow/tasks/mixing_optimization/kexp_normal/config/multconfig.xml
