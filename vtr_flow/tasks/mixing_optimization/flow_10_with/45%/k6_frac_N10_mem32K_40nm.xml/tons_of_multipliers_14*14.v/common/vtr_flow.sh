...
#Begin I/O redirection
{
    ...
    /home/george/vtr-verilog-to-routing/vtr_flow/scripts/run_vtr_flow.pl /home/george/vtr-verilog-to-routing/vtr_flow/benchmarks/mix_soft_and_hard_logic//tons_of_multipliers_14*14.v /home/george/vtr-verilog-to-routing/vtr_flow/arch/mix_soft_and_hard_logic/k6_frac_N10_mem32K_40nm.xml  -name 'mixing_optimization/flow_10_with: k6_frac_N10_mem32K_40nm.xml/tons_of_multipliers_14*14.v/common'   -temp_dir .  -custom_odin_config_full_name /home/george/vtr-verilog-to-routing/vtr_flow/tasks/mixing_optimization/flow_10_with/config/multconfig.xml
